...
def main():
	...
	st.text("Evaluate and Predict the Quality of A Car")
	...
	if choices == 'Gallery':
		...
		all_images = ["cars_images/car1.jpg","cars_images/car2.jpg","cars_images/car3.jpg","cars_images/car4.jpeg","cars_images/car5.jpg"]
		# st.write(all_images)
		img_choice = st.selectbox('Select Car',all_images)
		
		st.image(load_image(img_choice),width=500, caption='Images')
